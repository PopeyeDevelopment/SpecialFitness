...
public interface KeyUtils {
    ...
    public static final String WORKOUT_WEIGHT_INCREMENTS_KEY = getStringFromResId(R.string.default_weight_increment_key);
    public static final String WORKOUT_DEFAULTS_KEY = getStringFromResId(R.string.workout_default_switch_key);
